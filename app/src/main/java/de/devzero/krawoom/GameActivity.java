...
public class GameActivity extends SimpleBaseGameActivity implements IAccelerationListener, IOnSceneTouchListener {
    ...
    public void onCreateResources() throws IOException {
        ITexture mBoxFaceTexture = new AssetBitmapTexture(this.getTextureManager(), this.getAssets(), "box.png", TextureOptions.BILINEAR);
        this.mBoxFaceTextureRegion = TextureRegionFactory.extractTiledFromTexture(mBoxFaceTexture, 2, 1);
        mBoxFaceTexture.load();

        ITexture mCircleFaceTexture = new AssetBitmapTexture(this.getTextureManager(), this.getAssets(), "ball.png", TextureOptions.BILINEAR);
        this.mCircleFaceTextureRegion = TextureRegionFactory.extractTiledFromTexture(mCircleFaceTexture, 2, 1);
        mCircleFaceTexture.load();
    }
